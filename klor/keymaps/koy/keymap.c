...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
     ...
     KC_TAB         , LGUI_T(DE_H)  , LALT_T(DE_A)  , LCTL_T(DE_E)  , LT(_SYM,DE_I) , DE_U          ,                                 DE_D          , LT(_SYM,DE_T) , RCTL_T(DE_R)  , RALT_T(DE_N)  , RGUI_T(DE_S)  , DE_Z          ,\
     LCTL(DE_CIRC)  , DE_X          , DE_Q          , DE_ADIA       , DE_UDIA       , DE_ODIA       , KC_MUTE       , KC_MPLY       , DE_B          , DE_P          , DE_W          , DE_M          , DE_J          , DE_F          ,\
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_SYM]  = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD), ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
