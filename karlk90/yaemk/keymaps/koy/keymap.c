...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
   ...
   [_FN] = LAYOUT( \
    _______         , _______       , _______       , _______       , _______       , QK_BOOTLOADER , _______       ,                                 _______       , QK_BOOTLOADER , KC_F10        , KC_F11        , KC_F12        , _______       , _______       ,\
    _______         , _______       , _______       , _______       , _______       , KC_PSCR       , _______       ,                                 _______       , _______       , KC_F7         , KC_F8         , KC_F9         , _______       , _______       ,\
    _______         , _______       , LGUI(KC_PGUP) , _______       , LGUI(KC_PGDN) , _______       , _______       ,                                 _______       , _______       , KC_F4         , KC_F5         , KC_F6         , _______       , _______       ,\
